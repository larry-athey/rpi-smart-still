...
function SpeakMessage($ID) {
  ...
  $Msg[37]  = "Updating the hydrometer reader zero percent calibration position";
  $Msg[38]  = "Updating the hydrometer reader 100 percent calibration position";
  $Msg[39]  = "Updating the flow sensor empty capacitance value";
  $Msg[40]  = "Updating the flow sensor full capacitance value";
  ...
  $Msg[65]  = "Boiler has reached minimum operating temperature. Reducing Boilermaker power to " . $Program["heating_idle"] . " percent";
