...
(1, 'Maximum Reflux', 1, 0, 0, 0, 0, 40, 35, 1, 78.5, 90, 1, 55, 60, 0, 0, 0, 128, 'This is an example program for my Still Spirits boiler and T-500 column, using the exact parts shown in the diagrams provided on GitHub. Unless you are using the 100% exact setup, this program likely will not work for you. Always create your own programs from scratch since there is no way to create a program that is guaranteed to work with every still under the sun.'),
(2, 'Normal Pot Still  (70 proof shutdown)', 0, 35, 1, 0, 0, 0, 45, 1, 78.5, 90, 0, 0, 0, 1, 82, 87, 127, 'This is an example program for my Still Spirits boiler and T-500 column, using the exact parts shown in the diagrams provided on GitHub. Unless you are using the 100% exact setup, this program likely will not work for you. Always create your own programs from scratch since there is no way to create a program that is guaranteed to work with every still under the sun.'),
(3, 'Mild Reflux (Enhanced Pot Still)', 1, 0, 0, 0, 0, 35, 35, 1, 78.5, 89.6, 1, 72, 77, 0, 0, 0, 130, 'This is an example program for my Still Spirits boiler and T-500 column, using the exact parts shown in the diagrams provided on GitHub. Unless you are using the 100% exact setup, this program likely will not work for you. Always create your own programs from scratch since there is no way to create a program that is guaranteed to work with every still under the sun.'),
(4, 'Moderate Reflux', 1, 0, 0, 0, 0, 40, 35, 1, 78.5, 90, 1, 57, 62.3, 0, 0, 0, 130, 'This is an example program for my Still Spirits boiler and T-500 column, using the exact parts shown in the diagrams provided on GitHub. Unless you are using the 100% exact setup, this program likely will not work for you. Always create your own programs from scratch since there is no way to create a program that is guaranteed to work with every still under the sun.');
