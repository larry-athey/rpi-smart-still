...
function CalibrateHydrometer($DBcnx) {
  ...
  if ($Settings["hydro_type"] == 0) {
    ...
    $Content .=     "<div class=\"row\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?reboot_hydro=1\" class=\"btn btn-outline-danger btn-sm fw-bolder $Disabled\" style=\"width: 100%;\">Reboot LIDAR Hydrometer Reader</a></div>";
    $Content .=     "</div>";
    $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?recalibrate_hydro=1&slot=0\" class=\"btn btn-primary btn-sm fw-bolder $Disabled\" style=\"width: 100%;\">Calibrate Hydrometer 0% Position</a></div>";
    $Content .=     "</div>";
    $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?recalibrate_hydro=1&slot=1\" class=\"btn btn-primary btn-sm fw-bolder $Disabled\" style=\"width: 100%;\">Calibrate Hydrometer 100% Position</a></div>";
    $Content .=     "</div>";
    $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?recalibrate_hydro=1&slot=2\" class=\"btn btn-primary btn-sm fw-bolder $Disabled\" style=\"width: 100%;\">Calibrate Empty Flow Sensor</a></div>";
    $Content .=     "</div>";
    $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?recalibrate_hydro=1&slot=3\" class=\"btn btn-primary btn-sm fw-bolder $Disabled\" style=\"width: 100%;\">Calibrate Full Flow Sensor</a></div>";
    $Content .=     "</div>";
    $Content .=   "</div>";
    $Content .= "</div>";
  }
...
function Confirmation($DBcnx,$Type,$Data) {
  ...
  if ($Type == 1) {
    ...
    $Btn = "delete_program";
    $Cancel = "index.php?page=programs";
  } else {
    if ($Data == 1) {
