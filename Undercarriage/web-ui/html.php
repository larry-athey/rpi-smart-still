...
function CalibrateHydrometer($DBcnx) {
  ...
  if ($Settings["hydro_type"] == 0) {
    ...
    $Content  = "<div class=\"card\" style=\"width: 31em; margin-top: 0.5em; margin-bottom: 0.5em; margin-left: 1.25em; margin-right: 0.5em;\">";
    $Content .=   "<div class=\"card-body\">";
    $Content .=     "<p>By default, the LIDAR hydrometer reader is calibrated with a hydrometer using a 146mm scale. Placing a reflector 10mm above the 100% line will track accurately within +/- 1%.</p>";
    $Content .=     "<p>Use the buttons below to recalibrate the 10% division lines. Float your hydrometer with water, use the top of your parrot as the reference point. Watch for the blue light to flash on the reader chip to indicate that the new setting was saved.</p>";
    $Content .=     "<div class=\"row\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?reboot_hydro=1\" class=\"btn btn-danger btn-sm\">Reboot Device</a></div>";
    $Content .=       "<div class=\"col\"><a style=\"float: right;\" href=\"process.php?recalibrate_hydro=1&slot=0\" class=\"btn btn-primary btn-sm\">Calibrate 0%</a></div>";
    $Content .=     "</div>";
    $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?recalibrate_hydro=1&slot=1\" class=\"btn btn-primary btn-sm\">Calibrate 10%</a></div>";
    $Content .=       "<div class=\"col\"><a style=\"float: right;\" href=\"process.php?recalibrate_hydro=1&slot=2\" class=\"btn btn-primary btn-sm\">Calibrate 20%</a></div>";
    $Content .=     "</div>";
    $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?recalibrate_hydro=1&slot=3\" class=\"btn btn-primary btn-sm\">Calibrate 30%</a></div>";
    $Content .=       "<div class=\"col\"><a style=\"float: right;\" href=\"process.php?recalibrate_hydro=1&slot=4\" class=\"btn btn-primary btn-sm\">Calibrate 40%</a></div>";
    $Content .=     "</div>";
    $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?recalibrate_hydro=1&slot=5\" class=\"btn btn-primary btn-sm\">Calibrate 50%</a></div>";
    $Content .=       "<div class=\"col\"><a style=\"float: right;\" href=\"process.php?recalibrate_hydro=1&slot=6\" class=\"btn btn-primary btn-sm\">Calibrate 60%</a></div>";
    $Content .=     "</div>";
    $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?recalibrate_hydro=1&slot=7\" class=\"btn btn-primary btn-sm\">Calibrate 70%</a></div>";
    $Content .=       "<div class=\"col\"><a style=\"float: right;\" href=\"process.php?recalibrate_hydro=1&slot=8\" class=\"btn btn-primary btn-sm\">Calibrate 80%</a></div>";
    $Content .=     "</div>";
    $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
    $Content .=       "<div class=\"col\"><a href=\"process.php?recalibrate_hydro=1&slot=9\" class=\"btn btn-primary btn-sm\">Calibrate 90%</a></div>";
    $Content .=       "<div class=\"col\"><a style=\"float: right;\" href=\"process.php?recalibrate_hydro=1&slot=10\" class=\"btn btn-primary btn-sm\">Calibrate 100%</a></div>";
    $Content .=     "</div>";
    $Content .=   "</div>";
    $Content .= "</div>";
  }
...
function ControlRelays($DBcnx) {
  ...
  $Content  = "<div class=\"card\" style=\"width: 31em; margin-top: 0.5em; margin-bottom: 0.5em; margin-left: 1.25em; margin-right: 0.5em;\">";
  $Content .=   "<div class=\"card-body\">";
  $Content .=     "<p>Auxiliary relays can be connected to Pi GPIO pins 17 and 27 for controlling pumps independent of a program's settings.</p>";
  $Content .=     "<p>Keep in mind that you should always perform your valve calibration with water pressure against them since this can cause resistance which will affect the timing calculation.</p>";
  $Content .=     "<div class=\"row\" style=\"margin-top: 1.5em;\">";
  $Content .=       "<div class=\"col\">Auxiliary&nbsp;Relay&nbsp;#1</div>";
  ...
  $Content .=     "</div>";
  $Content .=     "<div class=\"row\" style=\"margin-top: 0.5em;\">";
  $Content .=       "<div class=\"col\">Auxiliary&nbsp;Relay&nbsp;#2</div>";
...
function StartRun($DBcnx) {
  ...
  if (($Settings["valve1_total"] == 0) || ($Settings["valve1_pulse"] == 0) || ($Settings["valve2_total"] == 0) || ($Settings["valve2_pulse"] == 0)) {
    $Content  = "<p class=\"text-danger\"><b>SYSTEM ERROR</b></p>";
    $Content .= "<p class=\"text-light\">The condenser and dephleg valve calibration is incomplete!</p>";
    $Content .= "<p class=\"text-light\">Please run the \"Calibrate Valves\" function with your valves under water pressure and start the run again.</p>";
  } else {
