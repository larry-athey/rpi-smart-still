...
Let me start off by saying that I'm no master distiller and don't pretend to be one. YouTube and other social media sites are already full of those kinds of self-idolizing hacks and frauds *(for example, Cyrus Mason and "Windsong", the Still'n The Clear charlatans)*. **I'm a hobby distiller, period.**
