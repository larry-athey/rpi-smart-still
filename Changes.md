...
- Improved Boilermaker API integration which allows the system to run the Boilermaker more like a digital SCR controller. As in, the boiler temperature is allowed to naturally rise over time, but is more precisely controlled within preset window.
