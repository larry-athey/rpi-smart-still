...
- Created a completely 3D printable system case that simplifies complete builds and caters to both headless and fully self-contained builds with local screen/tablet interfaces.
